...
const ICON_BASE_URL = 'https://ww-rv.github.io/fridgeapp/icon/';
function renderIcon(val) {
  if (!val) return '';
  if (val.endsWith('.svg')) return `<img src="${ICON_BASE_URL}${val}" class="p-icon" alt="" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><span class="p-icon emoji" style="display:none">📦</span>`;
